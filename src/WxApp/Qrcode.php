...
class Qrcode extends BaseWechat
{
   ...
   * @return array|string
   */
  public function get($path, $width = 430, $auto_color = false, $line_color = ["r" => "0", "g" => "0", "b" => "0"], $is_hyaline = false, $outType = null)
  {
    $url = 'https://api.weixin.qq.com/wxa/getwxacode?access_token=ACCESS_TOKEN';
    $this->parse_url($url, __FUNCTION__, func_get_args());
    $result = Http::post($url, Helper::arr2json([
      'path' => $path,
      'width' => $width,
    ...
    if (is_array($json = json_decode($result, true))) {
      if (!$this->requested && isset($json['errcode']) && in_array($json['errcode'], ['40014', '40001', '41001', '42001'])) {
        [$this->del_cache(), $this->requested = true];
        return call_user_func_array([$this, $this->currentMethod['method']], $this->currentMethod['arguments']);
      }
      return Helper::json2arr($result);
    }
   ...
   * @return array|string
   */
  public function getUnlimit($scene, $page, $width = 430, $auto_color = false, $line_color = ["r" => "0", "g" => "0", "b" => "0"], $is_hyaline = false, $outType = null)
  {
   ...
   * @return array|string
   */
  public function getQrCode($path, $width = 430, $outType = null)
  {
